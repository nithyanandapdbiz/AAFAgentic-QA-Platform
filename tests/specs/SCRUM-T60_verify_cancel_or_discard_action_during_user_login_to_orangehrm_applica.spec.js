...
//   2. [State: Form Empty] Verify the form starts in an empty state.
//   3. [State: Partially Filled] Enter First Name: &quot;CancelTest&quot; and Last Name: &quot;Partial&quot; without submitting.
//   4. Without clicking Save, click the Cancel button (or navigate away using the browser Back button).
//   5. [State: Cancelled] Observe what happens &mdash; browser may show an &quot;unsaved changes&quot; warning.
//   6. If a warning appears, confirm the discard action.
//   7. [State: Returned] Verify the user is returned to the previous page or employee list.
//   8. Navigate to the employee list and search for &quot;CancelTest&quot;. Verify no partial record exists.
//   9. Verify zero data was persisted from the cancelled form entry.
// =============================================================================
...
test.describe('SCRUM-T60 | Verify cancel or discard action during User Login to OrangeHRM Application', () => {
